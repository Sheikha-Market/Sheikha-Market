...
const ROOT_VOCAB = Object.freeze({
    ...
    // الكوني والشامل (15)
    'كون':171,'خلق':172,'آيات':173,'وجود':174,'إبداع':175,'صنع':176,'إتقان':177,
    ...
    // الاتصال والتكامل (20)
    'تكامل':217,'ربط':218,'توصيل':219,'تزامن':220,'تنسيق':221,'تواصل':222,
    'شبكة_خدمات':223,'واجهة':224,'بروتوكول':225,'تبادل':226,'دمج':227,'توحيد':228,
    'تنسيق_عالمي':229,'تعاون':230,'شراكة':231,'تحالف':232,'محادثة':233,
    'رسالة':234,'إشعار':235,'استجابة':236,
    // القيادة والتنظيم (20)
    'قيادة':237,'إشراف':238,'تنظيم':239,'توجيه':240,'تخطيط':241,'استراتيجية':242,
